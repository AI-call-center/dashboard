...
const FilterPanel = ({
  ...
  return (
    <>
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 bg-gray-800/50 rounded-lg border border-gray-700">
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-4 pt-4 border-t border-gray-700">
          <button
            onClick={() =>
              onFilterChange({
                statuses: [],
            ...
            className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-gray-400 hover:text-gray-300 text-center"
          >
            Reset Filters
          </button>
          <motion.button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-gray-300 bg-gray-700 rounded-lg hover:bg-gray-600"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 text-center"
          >
            Apply Filters
          </motion.button>
        </div>
